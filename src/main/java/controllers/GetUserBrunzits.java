 ...
 */
@WebServlet("/GetUserBrunzits")
public class GetUserBrunzits extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetUserBrunzits() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session != null || user != null) {
			...
			brunzits = brunzitManager.getUserBrunzits(user.getId());
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/ViewOwnBrunzits.jsp"); 

...
<div class="w3-container w3-card w3-round-xxlarge w3-white w3-section w3-center">
    ...
    <hr>
	<h4>Perfil de 0x${otherUser.userName}</h4>
	...
	<p class="w3-left-align">
		<i class="fa fa-info-circle fa-fw w3-margin-right"></i> Seguidors:
		${otherUser.followers}
	</p>
	<c:if test = "${user.isAdmin == 1}">
	
	<button type="button" id = "${otherUser.id}" class="deleteUserAdmin w3-row w3-button w3-round-xlarge w3-red w3-section">Delete Account</button>
